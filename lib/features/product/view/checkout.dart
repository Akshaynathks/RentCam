...
import 'package:rent_cam/features/product/bloc/payment_bloc/payment_bloc.dart';
...
import 'package:rent_cam/features/product/view/oder_confirmation.dart';
  ...
  Widget _buildOrderButton() {
    return BlocConsumer<PaymentBloc, PaymentState>(
      ...
      builder: (context, state) {
        ...
        // Calculate partial amount for online payment
        final partialAmount = cartItems.fold(
            0.0,
            (sum, item) =>
                sum + (item.isPartialPayment ? item.partialAmount : 0));
