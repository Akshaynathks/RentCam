...
import 'package:rent_cam/features/home/view/checkout.dart';
import 'package:rent_cam/features/home/view/edit_cart.dart';
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 16),
          _buildSummaryRow('Total Payable', payableAmount.toStringAsFixed(1)),
          const SizedBox(height: 8),
          if (cartItems.any((item) => item.isPartialPayment)) ...[
            _buildSummaryRow(
                'Partial Amount:', partialAmount.toStringAsFixed(1)),
            _buildSummaryRow(
                'Balance Amount:', balanceAmount.toStringAsFixed(1)),
          ],
          const SizedBox(height: 16),
          Row(
              ...
              ElevatedButton(
                onPressed: () {
                  final isAnyPartial =
                      cartItems.any((item) => item.isPartialPayment);
                  final payableAmount =
                      isAnyPartial ? partialAmount : grandTotal;
